...
export function ProfileWidget() {
  ...
  return (
    <div id="profile-widget" className="md:col-span-4 te-card p-8 md:p-10 bg-neo-yellow text-black flex flex-col justify-between relative overflow-hidden group shadow-[8px_8px_0px_0px_#000] border-4 border-black min-h-[420px] lg:min-h-[380px]">
      {/* Online indicator */}
      <div className="absolute top-3 right-3 flex items-center gap-2 z-10">
        <span className="w-3 h-3 rounded-full bg-neo-green border-2 border-black animate-pulse"></span>
        <span className="font-mono text-[10px] font-black uppercase bg-black text-white px-2 py-0.5 border border-black rounded shadow-[1px_1px_0px_0px_#fff]">
          ONLINE
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center w-full my-auto">
        ...
        <div className="lg:col-span-3 space-y-2 text-center lg:text-left">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black leading-none uppercase select-none tracking-tighter">
            RISHI<br />
            <span className="bg-black text-white px-3 py-1.5 inline-block -skew-y-2 transform mt-2 select-none shadow-[6px_6px_0px_0px_var(--neo-pink)]">
              POPAT
            </span>
          </h1>
          <p className="font-mono text-[10px] lg:text-[11px] uppercase tracking-widest font-black opacity-80 mt-3">
            SYSTEM_OPERATOR // SECURE_PORT_01
          </p>
        </div>
        ...
        <div className="lg:col-span-3 flex flex-col justify-between space-y-6 self-stretch">
          {/* Metrics Panel */}
          <div className="border-2 border-black bg-white/45 p-4 rounded-lg font-mono text-[10px] space-y-2 select-none shadow-[4px_4px_0px_0px_#000] flex-1 flex flex-col justify-center">
            <div className="font-black border-b border-black pb-1.5 flex justify-between uppercase">
          ...
          <div className="flex flex-col gap-3 font-mono">
            <a 
              ...
              className="te-button w-full py-3 px-4 text-xs bg-black text-white border-2 border-black hover:bg-neo-pink hover:text-white transition-all text-center flex items-center justify-center gap-2 shadow-[3px_3px_0px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none font-black cursor-pointer"
            >
            ...
            <div className="flex gap-2">
              <a 
                href="#contact-widget" 
                className="te-button flex-1 py-2.5 px-4 text-[9px] sm:text-[10px] bg-white text-black border-2 border-black hover:bg-neo-cyan hover:text-black transition-all text-center shadow-[3px_3px_0px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none font-black cursor-pointer uppercase"
              >
                SEND ME A MESSAGE
              </a>
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-2.5 border-2 border-black bg-white rounded shadow-[3px_3px_0px_0px_#000] hover:bg-neo-green transition-colors flex items-center justify-center cursor-pointer"
              >
                <Github size={16} />
              </a>
            </div>
